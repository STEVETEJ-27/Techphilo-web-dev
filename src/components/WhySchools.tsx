          ...
          {pillars.map((p, i) => (
            ...
            >
              <div className="pillar-card__header">
                <div className="pillar-card__icon-wrap" style={{ background: `color-mix(in srgb, ${p.color} 7%, transparent)`, border: `1px solid color-mix(in srgb, ${p.color} 15%, transparent)` }}>
            ...
            {schoolOutcomes.map((o, i) => (
              ...
              >
                <span className="outcome-item__icon">
                  <o.Icon size={18} strokeWidth={1.8} style={{ color: 'var(--accent)' }} />
                </span>
                <span className="text-sm" style={{ color: 'var(--ink-soft)', lineHeight: 1.5 }}>{o.text}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
